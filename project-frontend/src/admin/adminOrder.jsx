...
export default function AdminOrder() {
    ...
    async function fetchOrders() {
        try {
            const res = await axios.get(import.meta.env.VITE_BACKEND_URL + '/api/rental/getrental');
            setOrder(res.data);
                                ...
                                <tr key={index} className="hover:bg-slate-50 transition-colors duration-200">
                                    ...
                                    <td className="px-6 py-4">
                                        <button
                                            ...
                                            className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white text-sm font-semibold rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
                                        >

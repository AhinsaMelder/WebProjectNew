...
export default function LeaserBooking() {
    ...
    async function fetchOrders() {
        ...
        try {
            const res = await axios.get(import.meta.env.VITE_BACKEND_URL + '/api/rental/getrentalfromSellers/' + email);
            setOrder(res.data);
                        ...
                        <div className="relative bg-white rounded-3xl shadow-2xl border border-slate-200 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                            ...
                            <div className="p-8 space-y-8">
                                ...
                                <div className="flex justify-end space-x-4 pt-6 border-t border-slate-200">
                                    ...
                                    <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                                        Send Email
                                    </button>
                                    <button 
